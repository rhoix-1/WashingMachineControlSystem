...
class Home_Window(tk.Frame):
	def __init__(self, parent, controller):
		...
		def start_press():
			# Checks if the buttons is normal/active or not
			
			print(start_button.cget("state"))
			print("okay this is the state")
			if start_button.cget("state") == "disabled":
				print("NOW YOU WORK?")
			elif start_button.cget("state") == "active" or "normal":
		...
		def pause_press():
			...
			print(pause_button.cget("state"))
			print("okay this is the state")
			
			if pause_button.cget("state") == "disabled":
				print("NOW YOU WORK?")
			elif pause_button.cget("state") == "active" or "normal":
		...
		def reverse_press():
			...
			print(reverse_button.cget("state"))
			print("okay this is the state")
			
			if reverse_button.cget("state") == "disabled":
				print("NOW YOU WORK?")
			elif reverse_button.cget("state") == "active" or "normal":
		...
		def hmenu_press():
			controller.show_frame(Settings_Window)

			
		def home_control_change(self):
			# Controls the physical buttons on the home page
			print("HELLO HGOME CONTROL?")
		...
		home_date_and_time_text.grid(row=0, column=2, columnspan=3, padx=(40))
		...
		# Settings Button
		settings_button = tk.Button(self, text="Settings", font=TEXT_FONT, command=hmenu_press)
...
class Settings_Window(tk.Frame):
	def __init__(self, parent, controller):
		...
		def first_row_func():
			btn6.when_pressed = lambda: user_settings_button_press(slow_agitation_speed_button, agitation_slow_speed_range, "RPM")
			btn7.when_pressed = lambda: user_settings_button_press(fast_agitation_speed_button, agitation_fast_speed_range, "RPM")
			btn8.when_pressed = lambda: user_settings_button_press(water_amount_button, water_amount_range, "ML")
		
		def second_row_func():
			btn6.when_pressed = lambda: user_settings_button_press(slow_agitation_duration_button, agitation_slow_duration_range, "MIN")
			btn7.when_pressed = lambda: user_settings_button_press(fast_agitation_duration_button, agitation_fast_duration_range, "MIN")

		def third_row_func():
			btn6.when_pressed = lambda: user_settings_button_press(slow_cycle_speed_button, cycle_slow_speed_range, "RPM")
			btn7.when_pressed = lambda: user_settings_button_press(fast_cycle_speed_button, cycle_fast_speed_range, "RPM")
			btn8.when_pressed = lambda: user_settings_button_press(soak_duration_button, soak_duration_range, "MIN")
			
		def fourth_row_func():
			btn6.when_pressed = lambda: user_settings_button_press(slow_cycle_duration_button, cycle_slow_duration_range, "MIN")
			btn7.when_pressed = lambda: user_settings_button_press(fast_cycle_duration_button, cycle_fast_duration_range, "MIN")
		
		def menu_press():
			controller.show_frame(Home_Window)
		...
		settings_date_and_time_text.grid(row=0, column=1, columnspan=3, padx=(95, 40))
	...
	def settings_control_change(self):
		# Controls the physical buttons on the home page
		btn2.when_pressed = first_row_func
		btn3.when_pressed = second_row_func
		btn4.when_pressed = third_row_func
		btn5.when_pressed = fourth_row_func
		
		btn9.when_pressed = menu_press
		btn10.when_pressed = shutdown_press
