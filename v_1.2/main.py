...
# Keeps track of which progression phase the washing machine is in
total_phases = ["intake_nump", "agitation_nump", "draining_nump", "uv_light_nump", "dispense_nump"]
phase_tracker = 0
...
class Home_Window(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def artificial_progression():
            ...
            global total_phases
            global phase_tracker
            print("Artifical Progress will start soon, Please wait my fellow lad")
            print(total_phases[phase_tracker])
        ...
        # Bottom Menu
        # Start Button
        start_button = tk.Button(self, text="Start", font=TEXT_FONT, command=artificial_progression)
        start_button.grid(row=11, column=0, pady=(35, 0), sticky="we")

        # Pause Button
        pause_button = tk.Button(self, text="Pause", font=TEXT_FONT, state="disabled")
        ...
        # THREAD CAUSES ERROR WHEN PROGRAM IS SHUTDOWN------------------------------------
